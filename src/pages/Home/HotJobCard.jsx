        ...
        <div className="card bg-base-100 shadow-sm">
           ...
           <figure>
            ...
            <div>
                ...
                <p className='flex gap-2 items-center'><FaMapMarkerAlt />
                {location}</p>
            </div>
            </div>
            <div className="card-body">
                ...
                {
                    requirements.map((skill, index) => <p key={index} className='border rounded-md text-center px-2 hover:text-black hover:bg-blue-300'>{skill}</p>)
                }
                </div>
